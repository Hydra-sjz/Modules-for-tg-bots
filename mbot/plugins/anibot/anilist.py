...
@Mbot.on_message(filters.command(["anime", f"anime{BOT_NAME}"], prefixes=trg))
@control_user
...
@Mbot.on_message(filters.command(["manga", f"manga{BOT_NAME}"], prefixes=trg))
@control_user
...
@Mbot.on_message(filters.command(["character", f"character{BOT_NAME}"], prefixes=trg))
@control_user
...
@Mbot.on_message(filters.command(["anilist", f"anilist{BOT_NAME}"], prefixes=trg))
@control_user
...
@Mbot.on_message(filters.command(["flex", f"flex{BOT_NAME}", "user", f"user{BOT_NAME}"], prefixes=trg))
@control_user
...
@Mbot.on_message(filters.command(["top", f"top{BOT_NAME}"], prefixes=trg))
@control_user
...
@Mbot.on_message(filters.command(["airing", f"airing{BOT_NAME}"], prefixes=trg))
@control_user
...
@Mbot.on_message(filters.private & filters.command("auth", prefixes=trg))
@control_user
...
@Mbot.on_message(~filters.private & filters.command(["settings", f"settings{BOT_NAME}"], prefixes=trg))
@control_user
...
@Mbot.on_message(filters.private & filters.command("code", prefixes=trg))
@control_user
...
@Mbot.on_message(filters.command(["me", f"me{BOT_NAME}", "activity", f"activity{BOT_NAME}"], prefixes=trg))
@control_user
...
@Mbot.on_message(filters.command(["favourites", f"favourites{BOT_NAME}"], prefixes=trg))
@control_user
...
@Mbot.on_message(filters.private & filters.command("logout", prefixes=trg))
@control_user
...
@Mbot.on_message(filters.command(["gettags", f"gettags{BOT_NAME}", "getgenres", f"getgenres{BOT_NAME}"], prefixes=trg))
@control_user
...
@Mbot.on_callback_query(filters.regex(pattern=r"page_(.*)"))
@check_user
...
@Mbot.on_callback_query(filters.regex(pattern=r"btn_(.*)"))
@check_user
...
@Mbot.on_callback_query(filters.regex(pattern=r"topanimu_(.*)"))
@check_user
...
@Mbot.on_callback_query(filters.regex(pattern=r"settogl_(.*)"))
...
@Mbot.on_callback_query(filters.regex(pattern=r"myacc_(.*)"))
@check_user
...
@Mbot.on_callback_query(filters.regex(pattern=r"myfavs_(.*)"))
@check_user
...
@Mbot.on_callback_query(filters.regex(pattern=r"myfavqry_(.*)"))
@check_user
...
@Mbot.on_callback_query(filters.regex(pattern=r"getusrbc_(.*)"))
@check_user
...
@Mbot.on_callback_query(filters.regex(pattern=r"fav_(.*)"))
@check_user
...
@Mbot.on_callback_query(filters.regex(pattern=r"(lsadd|lsupdt)_(.*)"))
@check_user
...
@Mbot.on_callback_query(filters.regex(pattern=r"(lsas|lsus|dlt)_(.*)"))
@check_user
...
@Mbot.on_callback_query(filters.regex(pattern=r"(desc|ls|char)_(.*)"))
@check_user
...
@Mbot.on_callback_query(filters.regex(pattern=r"lsc_(.*)"))
@check_user
...
@Mbot.on_callback_query(filters.regex(pattern=r"lsc(a|m)_(.*)"))
@check_user
