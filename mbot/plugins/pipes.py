...
from mbot import OWNER_ID, Mbot as pbot
...
@pbot.on_message(filters.command("activate_pipe") & filters.user(OWNER_ID))
...
@pbot.on_message(filters.command("deactivate_pipe") & filters.user(OWNER_ID))
...
@pbot.on_message(filters.command("pipes") & filters.user(OWNER_ID))
